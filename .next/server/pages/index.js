...
async function getStaticProps() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://centuaryfox007:jay125665911@cluster0.ws6gqly.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
